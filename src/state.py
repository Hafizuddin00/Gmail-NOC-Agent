...
class Email(BaseModel):
    ...
    attachments: str = Field(default="", description="Extracted text content from .txt and .log attachments")
    force_log_analysis: bool = Field(default=False, description="If True, skip LLM categorization and force log_analysis category")
